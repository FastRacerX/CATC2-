...
ef02188849911bfcec6da03afb = {
    ...
    "uwu": {"threads": 999, "max_active_bots": len(bot_ipv4_list), "methods": list(GLOBAL_METHODS)},
}
...
def show_bots_online():
    ...
    for _ in range(3):
        ...
        #   :import encode.decode('812d6afaabe74e058889a432b92f72c6'):    #
    ...
    if choice == "1":
        ...
        if not new_method:
            ...
            if new_method in GLOBAL_METHODS:
                ...
                ef02188849911bfcec6da03afb["uwu"]["methods"] = list(GLOBAL_METHODS)
